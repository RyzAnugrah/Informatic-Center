...
class CRUD2016 extends CI_Controller
{
	...
	function add()
	{
		...
		$this->form_validation->set_rules('id_matkul', 'id_matkul', 'required|trim');

		if ($this->form_validation->run() == false) {
			$this->load->view('v_add_2016');
		} else {
			...
			redirect(base_url('mahasiswa2016'));
		}
	}
	...
	function delete($npm)
	{
		...
		redirect(base_url('mahasiswa2018'));
	}
}