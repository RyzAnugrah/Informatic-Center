...
<body>
	<section class="container">
		<header>Hai
			...
			| <a href="<?php echo base_url('login/logout') ?>" title="Logout"><input type="button" class="buttonMenu" value="Logout"></a>
		</header>
		...
		<nav>
			<ul>
				...
				<li><a href="<?php echo base_url('mahasiswa') ?>" class="activebar">Data Mahasiswa</a></li>
		...
		<div class="pagination">
			...
			<a href="mahasiswa2017" style="background-color:#ff8000;">2017</a>
		...
		<?php
			...
			<a href="<?= site_url('CRUD2017/add') ?>"> <div  class="pagination" >Tambah Data</a></div>
		<?php } ?>
			...
			<tbody>
				...
				<tr>
					...
					<?php
						if($this->session->userdata('username') == 'admin'){ 
    				?>
							<td ><a href="<?= site_url('CRUD2017/delete/' . $user->npm) ?>"><i class="material-icons">delete</i></a></td>
