...
<body>
	<section class="container">
		...
		<div class="pagination">
			...
			<a href="mahasiswa2016" style="background-color:#ff8000;">2016</a>
		</div>
		
		<?php
			if($this->session->userdata('username') == 'admin'){ ?>
			<a href="<?= site_url('CRUD2016/add') ?>"> <div  class="pagination" >Tambah Data</a></div>
		<?php } ?>
			...
			<tbody>
				...
				<tr>
					...
					<?php
						if($this->session->userdata('username') == 'admin'){ 
    				?>
							<td ><a href="<?= site_url('CRUD2016/delete/' . $user->npm) ?>"><i class="material-icons">delete</i></a>
