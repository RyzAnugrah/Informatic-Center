...
<body>
	<section class="container">
		...
		<div class="pagination">
			...
			<a href="mahasiswa2018" style="background-color:#ff8000;">2018</a>
			<a href="mahasiswa2017">2017</a>
			<a href="mahasiswa2016">2016</a>
		</div>
		<?php
			if($this->session->userdata('username') == 'admin'){ ?>
			<a href="<?= site_url('CRUD2018/add') ?>"> <div  class="pagination" >Tambah Data</a></div>
		<?php } ?>
			...
			<tbody>
				...
				<tr>
					...
					<?php
						if($this->session->userdata('username') == 'admin'){ 
    				?>
							<td ><a href="<?= site_url('CRUD2018/delete/' . $user->npm) ?>"><i class="material-icons">delete</i></a></td>
